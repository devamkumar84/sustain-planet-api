...
// import 'package:sustain_planet/pages/upload_content.dart';
...
class ProfileScreenStateTwo extends State<ProfileScreenTwo>{
  ...
  //       });
  //   final SignInBloc sb = Provider.of<SignInBloc>(context, listen: false);
  //   sb.signInWithEmailPassword(emailCheckController.text.toString(), passwordCheckController.text.toString()).then((_) async{
  //     if(sb.hasError == false){
  ...
  //       openSnacbar(context, 'no internet');
  //     }else {
  //       sb.signInWithEmailPassword(emailCheckController.text.toString(), passwordCheckController.text.toString())
  ...
  //                 await ab.setAdminSignIn().then((value) {
  ...
  Widget build(BuildContext context) {
    ...
    //                       const Text('Sign Up',style: TextStyle(fontSize: 26,fontWeight: FontWeight.w600,color: Colors.deepPurple),),
...
class UserProfileData extends StatelessWidget{
  ...
  Widget build(BuildContext context){
    ...
    //                         TextButton(
    //                             onPressed: (){
    //                               sb.signOut().then((value) => sb.afterUserSignOut());
    //                               abm.afterAdminLogout();
    //                               Navigator.pop(context);
    //                               ScaffoldMessenger.of(context).showSnackBar(
    //                                 SnackBar(
    //                                   content: Container(
